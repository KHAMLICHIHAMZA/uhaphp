...
<div class="row form-group">
    ...
    placeholder="EmployeeID" value="<?php if (isset($e->EmployeeID)) echo $e->EmployeeID; ?>">
</div>
  </div>
  <div class="row form-group">
    ...
    placeholder="NationalIDNumber" value="<?php if (isset($e->NationalIDNumber)) echo $e->NationalIDNumber; ?>">
</div>
  </div>
  ...
  <div class="row form-group">
    ...
    placeholder="LoginID" value="<?php if (isset($e->LoginID)) echo $e->LoginID; ?>">
</div>
  </div>
  ...
  <div class="row form-group">
    ...
    placeholder="BirthDate" value="<?php if (isset($e->BirthDate)) echo date('d-m-Y',strtotime($e->BirthDate)); ?>">
    </div>
  </div>
  <div class="row form-group">
    ...
    placeholder="HireDate" value="<?php if (isset($e->HireDate)) echo date('d/m/Y',strtotime($e->HireDate)). ' ('.fAge($e->HireDate).' ans d\'ancienneté)'; ?>
">
    </div>
  </div>
  ...
  <div class="row form-group">
    ...
    placeholder="MaritalStatus" value="<?php if (isset($e->MaritalStatus)) echo $e->MaritalStatus;?>">
    </div>
  </div>
  ...
  <div class="row form-group">
    ...
    placeholder="Gender" value="<?php if (isset($e->Gender)) echo $e->Gender;?>">
    </div>
  </div>
  ...
  <div class="row form-group">
    ...
    placeholder="VacationHours" value="<?php if (isset($e->VacationHours)) echo $e->VacationHours; ?>">
    </div>
  </div>
  ...
  <div class="row form-group">
    ...
    placeholder="SickLeaveHours" value="<?php if (isset($e->SickLeaveHours)) echo $e->SickLeaveHours; ?>">
    </div>
  </div>
  ...
  <div class="row form-group">
    ...
    placeholder="EmailAddress" value="<?php if (isset($e->EmailAddress)) echo $e->EmailAddress; ?>">
    </div>
  </div>
  <div class="row form-group">
    ...
    placeholder="EmailPromotion" value="<?php if (isset($e->EmailPromotion)) echo $e->EmailPromotion; ?>">
        </div>
  </div>
  <div class="row form-group">
    ...
    placeholder="Phone" value="<?php if (isset($e->Phone)) echo $e->Phone; ?>">
  ...
  <div class="row form-group">
    ...
    placeholder="ETitle" value="<?php if (isset($e->ETitle)) echo $e->ETitle; ?>">
           </div>
  </div>
  <div class="row form-group">
    <div class="col-md-8">
  ...
  <div class="row form-group">
    ...
    placeholder="PhModifiedDateone" value="<?php if (isset($e->ModifiedDate)) echo $e->ModifiedDate; ?>" >
    </div>
  </div>

...
-->
  ...
  <div class="row">
    ...
    <div class="col-md-8">
      ...
      <?php if (isset($e->ManagerID)) echo ' <a href="index.php?c=employee&m=view&id='.
      $e->ManagerID.'" class="btn btn-success btn-sm" data-toggle="tooltip" title="Modifier l\'employé"><i class="fas fa-eye"></i> Voir</a>';?>
    </div>
  </div>
  <div class="row">
